...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJob":     schema_pkg_apis_mpi_v1_MPIJob(ref),
		"github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJobList": schema_pkg_apis_mpi_v1_MPIJobList(ref),
		"github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJobSpec": schema_pkg_apis_mpi_v1_MPIJobSpec(ref),
	}
}
...
func schema_pkg_apis_mpi_v1_MPIJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_mpi_v1_MPIJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/training-operator/pkg/apis/mpi/v1.MPIJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_mpi_v1_MPIJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
